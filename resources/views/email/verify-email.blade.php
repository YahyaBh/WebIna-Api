...
<body class="clean-body u_body" style="margin: 0;padding: 0;background-color: #f9f9f9;color: #1e1e1e">
        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse;vertical-align: top">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding-right: 0px;padding-left: 0px;"
                                                                    ...
                                                                    <amp-img alt="Image"
                                                                        src="https://i.ibb.co/q7C6swX/WEBINA-OG.png"
                                                                        width="400" height="400" layout="intrinsic"
                                                                        style="width: 21%;max-width: 21%;">
                    ...
                    <div style="padding: 0px;">
                        <div style="max-width: 600px;margin: 0 auto;background-color: #FFE662;">
                            <div class="u-row">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            style="font-size: 14px; color: #1e1e1e; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                            <p style="font-size: 14px; line-height: 140%;"><strong>T H A
                                                                    N K S&nbsp; &nbsp;F O R&nbsp; &nbsp;S I G N I N
                                                                    G&nbsp; &nbsp;U P !</strong></p>
                                                        </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            style="font-size: 14px; color: #1e1e1e;background-color: #FFE662; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    ...
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                                    ...
                                                                    button below to verify your email address and enjoy
                                                                    exclusive cleaning services with us! </span></p>
                                                        </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div align="center">
                                                            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:46px; v-text-anchor:middle; width:261px;" arcsize="8.5%"  stroke="f" fillcolor="#ffe662"><w:anchorlock/><center style="color:#1e1e1e;"><![endif]-->
                                                            <a target="_blank" class="v-button v-size-width"
                                                                style="box-sizing: border-box;display: inline-block;text-decoration: none;text-align: center;color: #1e1e1e; background-color: #ffe662; border-radius: 4px;  width:45%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; font-size: 14px;">
                                                                <a href="{{ $link }}"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            style="font-size: 14px; color: #1e1e1e; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                                    style="font-size: 20px; line-height: 32px;"><strong>Get
                                                                        in touch</strong></span></p>
                                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                                    style="font-size: 16px; line-height: 25.6px; color: #000000;">+212
                                                                    620792331</span></p>
                                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                                    style="font-size: 16px; line-height: 25.6px; color: #000000;"><a
                                                                        target="_blank"
                                                                        href="mailto:Info@webinadigital.com"
                                                                        rel="noopener">Info@webinadigital.com</a></span>
                                                            </p>
                                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                                    style="font-size: 16px; line-height: 25.6px; color: #000000;">www.webinadigital.com</span>
                                                            </p>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 33px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div style="text-align:center;line-height:0px">
                                                            <a href="https://linkedin.com/webina_digital"
                                                                target="_blank"
                                                            ...
                                                            <a href="https://youtube.com/webina_digital"
                                                                target="_blank"
                                                                style="display:inline-block;width:32px;height:32px;margin-right:17px">
                                                                <amp-img
